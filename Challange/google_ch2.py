...
# except that all the elevator documentation has been lying in a disorganized pile at the bottom of a filing cabinet 
...
# Small fixes or maintenance work can be represented by a third number named "revision", e.g. 1.1.1, 1.1.2, 1.2.0, 
# and so on. The number zero can be used as a major for pre-release versions of elevators, e.g. 0.1, 0.5, 0.9.2, etc 
...
# but one version contains more numbers than the others, then these versions must be sorted ascending based on
#  how many numbers they have, e.g ["1", "1.0", "1.0.0"]. The number of elements in the list l will be at least 
# 1 and will not exceed 100.
...
# New versions of an elevator increase the MAJOR number, e.g. 1, 2, 3
# new features MINOR 1.0, 1.1, 1.2, etc
# Small fixes or maintenance work can be represented by a third number named "REVISION", e.g. 1.1.1, 1.1.2, 1.2.0
# major for pre-release versions of elevators, e.g. 0.1, 0.5, 0.9.2, etc 
